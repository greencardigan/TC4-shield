...
void setup() {
  ...
  //app.setAmbFilter( 85 ); // optional; required only if override of default (80) is desired
  app.initTempFilters(); // required; override with non-default values if desired (default 10)
  app.initRiseFilters(); // required; override with non-default values if desired (default 85)
  app.initRoRFilters(); // required; override with non-default values if desired (default 80)
