...
#define MIN_OT11 0 // Set output % for lower limit for OT11.  0% power will always be available
#define MAX_OT11 100  // Set output % for upper limit for OT11
...
#ifdef CONFIG_FAST_PWM // nothing special to configure -- this is the default
  #define OT11_PIN 11
#endif
