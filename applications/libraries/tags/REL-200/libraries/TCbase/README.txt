...
Provides support for ITS-90 thermocouple linearization,
Type K thermocouples.

Create a folder and place these files in
C:/Program Files/arduino-0018/libraries/TCbase on your computer.
